"""Mem0 wrapper used by the support copilot."""
...
except ImportError:  # pragma: no cover - import path depends on installed package
    Memory = None


class CustomerMemoryStore:
    """Simple interface over Mem0 for customer-specific memories."""
    ...
    def _add_messages(
        ...
        try:
            ...
            # Compatibility with Mem0 versions where metadata is not accepted.
...
class NoopMemoryStore:
    """Fallback memory store used when Mem0 cannot be initialized."""

    def __init__(self, reason: str = "Mem0 unavailable"):
        self.reason = reason

    def search(self, query: str, user_id: str, limit: int = 5) -> list[dict[str, Any]]:
        _ = (query, user_id, limit)
        return []
    ...
    def add_interaction(
        ...
        _ = (user_id, user_input, assistant_response, metadata)
    ...
    def add_resolution(
        ...
        _ = (user_id, ticket_subject, ticket_description, accepted_draft, entity_links)
